...
<main class="container">
  ...
  <h6 class="border-bottom pb-2 mb-0">Recursos</h6>
  <?php foreach ($recursosData as $row): ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createCompanyModalLabel">Создать новою тему - Recursos</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <!-- Форма для заполнения данных новой компании -->
                    <form action="bd/add-recursos.php" method="post">
                        <div class="mb-3">
                            <label for="titlo" class="form-label">Заголок</label>
                            <input type="text" class="form-control" id="titlo" name="titlo" required>
                        </div>
                        <div class="mb-3">
                            <label for="coment" class="form-label">Описание Темы</label>
                            <textarea class="form-control" id="coment" name="coment" rows="3"
                                required></textarea>
                        </div>
                        <div class="mb-3">
                          <label for="formFile" class="form-label">Выберите файл которой хотите поделится Не работаааааает</label>
